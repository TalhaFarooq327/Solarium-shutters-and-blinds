      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {shutters.map((s) => (
            <article
              key={s.name}
              className="group relative flex flex-col overflow-hidden rounded-2xl bg-card ring-1 ring-border/60 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_30px_60px_-30px_rgba(60,45,30,0.35)]"
            >
